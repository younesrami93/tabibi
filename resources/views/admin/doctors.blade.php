            ...
            <form action="{{ route('doctors.index') }}" method="GET">
                <div class="input-group">
                    ...
                    <input type="text" name="search" class="form-control border-0 bg-white"
                        placeholder="Search by Doctor Name, Email, or Clinic..." value="{{ request('search') }}">
                    <button class="btn btn-primary fw-bold px-4 rounded-end-3 d-none">Search</button>
                </div>
            </form>
        </div>
    </div>
                        ...
                        <tr>
                            <td class="ps-4">
                                <div class="d-flex align-items-center">
                                    <img src="https://ui-avatars.com/api/?name={{ $doctor->name }}&background=random"
